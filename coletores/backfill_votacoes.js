...
async function main() {
  ...
  const metas = [];
  let i = 0, comMateria = 0, comEmenta = 0, comAutor = 0, falhas = 0;
  ...
  console.log(`✅ ${metas.length} gravadas — ${comMateria} com matéria, ${comEmenta} com ementa, ${comAutor} com autor. ${falhas} falhas (não sobrescritas).`);
}
